...
from barefoot_winnie.d07_pipelines.pipeline import create_pipeline
from barefoot_winnie.d07_pipelines.pipeline import create_train_pipeline
...
def create_catalog(config: ConfigLoader, **kwargs) -> DataCatalog:
    ...
    catalog.add_feed_dict(conf_params)
    return catalog
